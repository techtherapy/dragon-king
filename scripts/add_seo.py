...
# One sharing card per language — a shared link previews with og:image, and
# an English card told French readers to "READ IN CHINESE · PINYIN · ENGLISH".
# Generated by scripts/generate_og_images.py.
OG_IMAGE = {
    "en": f"{SITE}/assets/og-image.jpg",
    "es": f"{SITE}/assets/og-image-es.jpg",
    "fr": f"{SITE}/assets/og-image-fr.jpg",
}
OG_ALT = {
    "en": "A golden dragon coiled around a flaming pearl beneath a radiant Buddha "
          "— The Sutra Spoken by the Buddha on the Sea Dragon King",
    "es": "Un dragón dorado enroscado alrededor de una perla llameante bajo un Buda "
          "radiante — El Sutra Pronunciado por el Buda sobre el Rey Dragón del Mar",
    "fr": "Un dragon d'or enroulé autour d'une perle flamboyante sous un Bouddha "
          "radieux — Le Soutra prononcé par le Bouddha sur le Roi Dragon de la Mer",
}
...
def article(url, headline, description, author_is_guru=True, image=None, lang="en"):
    node = {
        "@type": "Article",
        "headline": headline,
        "description": description,
        "image": image or OG_IMAGE[lang],
        "url": url,
...
def build_block(page, title, desc, lang="en"):
    ...
    lines = [
        ...
        *[f'<link rel="alternate" hreflang="{code}" href="{urls[code]}">' for code in LANGS],
        ...
        f'<meta property="og:image" content="{OG_IMAGE[lang]}">',
        '<meta property="og:image:width" content="1200">',
        '<meta property="og:image:height" content="630">',
        f'<meta property="og:image:alt" content="{html.escape(OG_ALT[lang], quote=True)}">',
        ...
        *[f'<meta property="og:locale:alternate" content="{OG_LOCALE[code]}">'
        ...
        f'<meta name="twitter:image" content="{OG_IMAGE[lang]}">',
        f'<meta name="twitter:image:alt" content="{html.escape(OG_ALT[lang], quote=True)}">',
        '',
