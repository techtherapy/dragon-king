...
VOLUME_OF = {  # chapter number -> volume label
    **{n: "卷一 · Volume One" for n in range(1, 5)},
    **{n: "卷二 · Volume Two" for n in range(5, 10)},
    **{n: "卷三 · Volume Three" for n in range(10, 16)},
    **{n: "卷四 · Volume Four" for n in range(16, 21)},
}
...
<footer class="site-footer">
  <div class="footer-crest" aria-hidden="true">
    <svg viewBox="0 0 100 100" fill="none">
      <path d="M50 24 C43.5 36 42.5 51 50 61 C57.5 51 56.5 36 50 24 Z" fill="#d9b25f"/>
      <path d="M33 33 C31.5 45 36 56.5 47.5 61.5 C42.5 51 40 41.5 33 33 Z" fill="#d9b25f" opacity=".85"/>
      <path d="M67 33 C68.5 45 64 56.5 52.5 61.5 C57.5 51 60 41.5 67 33 Z" fill="#d9b25f" opacity=".85"/>
      <path d="M19 45 C21 55 29.5 62.5 45 64.5 C36.5 58 27.5 51.5 19 45 Z" fill="#8d7440" opacity=".85"/>
      <path d="M81 45 C79 55 70.5 62.5 55 64.5 C63.5 58 72.5 51.5 81 45 Z" fill="#8d7440" opacity=".85"/>
      <path d="M31 70 C39 75.5 61 75.5 69 70" stroke="#8d7440" stroke-width="1.4"/>
      <circle cx="50" cy="15" r="1.8" fill="#d9b25f"/>
    </svg>
  </div>
