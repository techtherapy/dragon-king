...
def paragraphs(path, skip):
    ...
    for i, line in enumerate(path.read_text(encoding="utf-8").splitlines()):
        ...
        t = t.replace("Sam-man-doh, moo-toh-nam, wah-ri-la, men",
                      "sam-man-doh, moo-toh-nam, wajila, mee")
...
UI = {
    "en": {
        ...
        "g_mantra": "Mantra",
        "g_mantra_v": "Namo sam-man-doh,<br>moo-toh-nam,<br>wajila, mee",
    ...
    "es": {
        ...
        "g_mantra": "Mantra",
        "g_mantra_v": "Namo sam-man-doh,<br>moo-toh-nam,<br>wad-lli-la, mi",
